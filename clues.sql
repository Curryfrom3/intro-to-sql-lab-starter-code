...
SELECT cities.name, countrycode FROM cities
Join countries ON cities.countrycode = countries.code
WHERE cities.name LIKE 'Ser%' AND cities.name NOT LIKE '%le'
AND region = 'South America';
-- when followed by space you are renaming exp countrylanguages cl
...
-- Santa Monica! she will make it 91085 but its currently 91084